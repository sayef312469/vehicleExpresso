    ...
    return (
      <div className="user" onClick={(e)=>{
          ...
          <form ref={longtermRef} className="popup">
            ...
            <fieldset>
              ...
              <div className="block">
                ...
                <input type="text" id="vehiclecompany" name="vehiclecompany" />
              </div>
              <div className="block">
              ...
              <div className="block">
                ...
                <input type="text" id="serviceid" name="serviceid" placeholder="(For Old Customers)" />
              </div>
              <legend>Enter your desired service:</legend>
              <div className="check">
                <input type="checkbox" id="vehiclerepair" name="servicetype" value="repair"></input>
                <label htmlFor="vehiclerepair">Vehicle Repair</label>
                <label htmlFor="repairtype">Repair Type:</label>
                <textarea id="repairtype" name="repairtype" className="description"></textarea>
              </div>
              <div className="check">
                <input type="checkbox" id="vehiclewash" name="servicetype" value="wash" />
                <label htmlFor="vehiclewash">Vehicle Wash</label>
                <label htmlFor="washtype">Wash Type:</label>
                <textarea id="washtype" name="washtype" className="description"></textarea>
              </div>
        ...
        {visible2 && !exit2 && (
          ...
          <fieldset>
            <legend>(SHORTTERM CARE)<br></br>ENTER YOUR VEHICLE INFO</legend>
            <div className="block">
        ...
        <div>
        <span>| Bills |______________________________________________________________________|History|</span>
        </div>
    </div>
  );
}
