...
const Modal = ({row,Update,closeModal}) => {
    ...
    const HandleGenerateBill =((e)=>{
        ...
        const rows=[
            ...
            [``,`Labor Cost`,`${row.SERVICING_COST-(row.REPAIR.COST+row.WASH.COST)}`],
            ...
            <form className='form-group'>
                <fieldset>
                    <div>
                        ...
                        <input name='mechanic' value={mechanic} onChange={(e)=>{setMechanic(e.target.value)}}/>
                    </div>
                    <div>
                        <label htmlFor='repair-cost'>Repair Cost:</label>
                        <input name='repair-cost' value={repairCost} onChange={(e)=>{setRepairCost(e.target.value)}}/>
                    </div>
                    <div>
                        <label htmlFor='wash-cost'>Wash Cost:</label>
                        <input name='wash-cost' value={washCost} onChange={(e)=>{setWashCost(e.target.value)}}/>
                    </div>
                    <div>
                        <label htmlFor='laborcost'>Cost(per hour):</label>
                        <input name='laborcost' value={laborCost} onChange={(e)=>{setLaborCost(e.target.value)}}/>
                    </div>
                    <div>
                        <label htmlFor='laborhour'>Labor Hours:</label>
                        <input name='laborhour' value={laborHour} onChange={(e)=>{setLaborHour(e.target.value)}}/>
                    </div>
                    <div>
                    ...
                    <span style={{ color: 'red' }} >(Submit before generating the updated bill)</span>
                    <div>
